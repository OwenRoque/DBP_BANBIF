                            ...
                            <div class="login_main">
                                <div class="login_parts">
                                    ...
                                    <div class="login_separator">
                                        <span class="login_separator_text">Paso 2 de 4: </span>
                                        ...
                                        <div class="login_content_form">
                                            ...
                                            <form style="margin-top: -10px;" method="get">
                                                <div class="login_boxdrop">
                                                    <span class="login_boxdrop_text, text_small">Clave de tarjeta (4 dígitos)</span>
                                                    <div class="login_content_main_data">
                                                        <input class= "login_user_extended" style="margin-left: 15px;" id="clave" name="clave" placeholder="Clave de tarjeta (4 dígitos)">                                           
                                                    </div>  
                                                </div>
                                                <h4 class="h4_tittle">Crea ahora tu contraseña para la Banca por internet o APP</h4>
                                                <div class="login_boxdrop">
                                                    <div class="login_text_container"><span class="login_boxdrop_text, text_small">Nueva contraseña</span></div>
                                                ...
                                                <div class="login_boxdrop">
                                                    <span class="login_boxdrop_text, text_small">Repetir nueva contraseña</span>
                                                    <div class="login_content_main_data">
                                                        <input class= "login_user_extended" style="margin-left: 15px;" id="clave" name="clave" placeholder="Repetir nueva contraseña">                                           
                                                    </div>  
                                                </div>
                                                <div style="clear:both;"></div>
                                            </form>
