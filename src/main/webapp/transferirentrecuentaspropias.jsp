...
<body>   
    ...
    <form method="POST" action="TransferirEntreCuentasPropias"> 
        <br>
        <h1>Transferir</h1>
        <br>
        <div class='mis_targetas_bambif'>
            <select name='mis_targetas_bambif' class="select_targetas">
                <option selected>Entre mis cuentas</option>  
            </select>
        </div>
        ...
        <div class="programar">
            ...
            <h5>Para transferencias y Pagos Programados con cambio de moneda, se muestra un tipo de cambio referencial.
                EL tipo de cambio final, sera el que esta vigente el día que se realice la transferencia o pago.</h5>
        </div>
        <br>
        <br>
