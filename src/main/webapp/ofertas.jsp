...
<body>   
    ...
    <div class='contenido-text'>
        <img class="ofertas-img" src="img/image_01.png" alt="Ofertas" >
        <img class="ofertas-img" src="img/image_02.png" alt="Ofertas" >
        <img class="ofertas-img" src="img/image_03.png" alt="Ofertas" >
        <img class="ofertas-img" src="img/image_04.png" alt="Ofertas" >
        <img class="ofertas-img" src="img/image_05.png" alt="Ofertas" >
    </div>
