...
<body>
    ...
    <div class="contenido-text">
        <div class="page-header">
            <div class="exit"><img src="icons/exit.png" width="20px" height="20px"  ></div>
            <div class="exit"><img src="icons/ahorro.png" width="30px" height="30px" ></div>
            <h3 class="text-left">
                09151316581321 | 0515646545412 | Nombre Personalizado
            </h3>
        </div>
        <div class="container-fluid">
            <ul class="full-box list-unstyled page-nav-tabs">
                <li>
                    <a class="active" href="ahorro.jsp">Movimientos</a>
                </li>
                <li>
                    <a href="estado.jsp">Estado</a>
                </li>
                <li>
                    <a href="detalles.jsp">Detalles</a>
                </li>
            </ul>
        </div>
        <div class="container-mov">
            <fieldset>
                <div class="form-group">
                    ...
                    <input type="date" class="form-control" name="fecha_inicio" id="admin-dni">
                </div>
                <div class="form-group">
                    <label for="prestamo_estado" class="bmd-label-floating">Movimineto</label>
                    <select class="form-control" name="mov" id="item_estado">
                ...
                <div class="form-group">
                    <label for="prestamo_estado" class="bmd-label-floating">Tipo de Movimiento</label>
                    <select class="form-control" name="mov" id="item_estado">
                        <option value="regular">Todos</option>
                        <option value="diferidos">Abono</option>
                        <option value="retenidos">Cargo</option>
                    </select>
                </div>
            </fieldset>
        </div>
