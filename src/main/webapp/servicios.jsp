    ...
    <form method="POST" action="Servicios"> 
        ...
        <div class='mis_targetas_bambif'>
            <select name='mis_targetas_bambif' class="select_targetas">
                <option selected>Servicio a pagar</option> 
            </select>
        </div>
        <div class='formulario_tarjetas'>
            ...
            <div class="programar">
                ...
                <h5>Para transferencias y Pagos Programados con cambio de moneda, se muestra un tipo de cambio 
                    referencial. EL tipo de cambio final, sera el que esta vigente el día que se realice la 
                    transferencia o pago.</h5>
            </div>
        <br>
        <br>
        </div>
