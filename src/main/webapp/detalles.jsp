...
<body>
    ...
    <div class="contenido-text">
        ...
        <div class="container-fluid">
            <ul class="full-box list-unstyled page-nav-tabs">
                <li>
                    <a href="ahorro.jsp">Movimientos</a>
                </li>
                <li>
                    <a href="estado.jsp">Estado</a>
                </li>
                <li>
                    <a class="active" href="detalles.jsp">Detalles</a>
                </li>
            </ul>
        </div>
	<div class="container-mov">
            <fieldset>
                <table class="default">
                    <tr>
                        <th><p style="text-align: left">Saldos</p></th>
                    </tr>
                    <tr>
                        <td width="1100px">Disponible</td>
                        <td>S/. 0.00</td>
                    </tr>
                    <tr>
                        <td width="700px">Contable</td>
                        <td>S/. 0.00</td>
                    </tr>
                </table>
            </fieldset>
