            ...
            <div class>
                <div class="obligatorio">
                    ...
                    <div class='partes'>
                        ...
                        <table>
                            <tr>
                                <td><label><input name="monto" value="Monto" type="checkbox">Monto</label></td>
                                <td><input type='number' placeholder="Ingrese monto"></td>
                            </tr>
                            <tr>
                                <td><label><input name="monto" value="Monto" type="checkbox">No pagar esta moneda</label></td>
                            </tr>
                        </table>
                    </div>
                    <div class='partes'>
